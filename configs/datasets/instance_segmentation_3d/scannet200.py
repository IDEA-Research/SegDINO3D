...
scannet200_train_mask = dict(
    type='ScanNet200InstanceSeg3D',
    scene_set="train",
    root_scenes="data/scannet200",  #! change to your data path
    use_super_points=True,
    root_points_2dfeats="data/features_2d/scannet200",    #! change to your 2D feature path
    transform_cfg=dict(
    ...
    dataset_type="scannet200_train_mask3d",
)

scannet200_val_mask = dict(
    scene_set="val",
    root_scenes="data/scannet200",  #! change to your data path
    use_super_points=True,
    root_points_2dfeats="data/features_2d/scannet200",    #! change to your 2D feature path
    ...
    mode_fuse_multi_scale_2d_feats="mean",
    dataset_type="scannet200_val_mask3d",
)
